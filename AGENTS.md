...
- **운영 환경 실측: `docs/ops/PROD-SNAPSHOT-2026-09-02.md`** (현재 기준)
  — `docs/ops/PROD-SNAPSHOT-2026-08-20.md`는 **⚠ 무효**다. 2026-08-28 창이 운영을 바꿨고
  09-02 스냅샷이 대체했다. **현재 상태의 근거로 인용하지 않는다** (§1.1).
  단 `avatars` 객체·런타임 버전은 09-02에 재조회되지 않아 08-20이 마지막 실측이다
