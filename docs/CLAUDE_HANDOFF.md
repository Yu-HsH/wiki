...
| §3.2 | RELEASE HOLD 사유 = 운영 적용·Edge Function·dry-run·Release A~D 승인 | **4개 전부 완료.** 지금 HOLD 사유는 ~~**W9 미해결 4건**~~ → **2026-08-29 조사 후 2건(발견 3·6) + 발견 4 수정의 배포** | W5·W6·W8·**W9** |
...
- **RELEASE: `HOLD` — 그러나 사유가 완전히 바뀌었다.**
  ...
  | **2026-08-29 (현재)** | ~~**W9 미해결 4건**~~ → **2026-08-29 조사 후 2건** — `wiki-snapshot` 429 대량 재발(그룹), 관전 이모티콘 미전달. ~~RETIRE 사유 불일치~~는 수정 완료·**미배포**, ~~`username-lookup` 404~~는 **결함 아님으로 종결**. 목록은 `CURRENT.md` §5.5 |
...
1. **`docs/agent/CURRENT.md` §5.5의 W9 미해결 항목이 1순위다.** ~~4건이며 착수 순서 제안은
   3 → 4 → 5 → 6이다.~~ → **2026-08-29 조사로 2건이 닫혔다. 남은 착수 순서는 3 → 6이며
   게이트 해제(W10)를 실제로 막는 것은 3번 + 4번 수정의 배포다.**
