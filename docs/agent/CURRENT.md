...
**운영·외부 확인 4건(P4·P5·P7·P9), 사용자 합의 1건(P10), 파일 준비 1건(P12)이다.**
...
| P10 | **삭제 범위 사전 합의** | 사용자 합의 | **판정 기준이 2026-08-27에 바뀌었다.** 먼저 §5.3-0의 `w6_blocking_rows`를 측정한다 — **0보다 크면 삭제는 선택이 아니다**(건너뛰면 W6가 #10에서 실패). 그 다음 §5.3 (1)(2) 측정치를 보고 삭제를 승인한다 |
