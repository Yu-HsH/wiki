...
마지막 **코드** 커밋: **이 갱신 커밋** — **N2 해소가 코드 변경이다** (`pages/MainPage.jsx` ·
`tests/explorationRecords.test.js`). 그 앞은 트랙 A(`e70c541`)·B(`7a7197e`) 통합
(`b3da192` · `527f896` · `eeb7a16`). `0ad3cde` 이후 들어온 코드 변경 전부가
**아직 배포되지 않았다** (§3)
